//! iptv-org's own index of what playlists exist: categories, languages and
//! countries, with the codes their `.m3u` URLs are built from.
//!
//! Vendored verbatim from MovieBox-Tui `src/tui/iptv_data.rs` (MIT OR
//! Apache-2.0, https://github.com/mesamirh/MovieBox-Tui). Kept as data rather
//! than fetched, so the picker renders instantly and offline; the playlists
//! themselves are still fetched and cached at use time.
