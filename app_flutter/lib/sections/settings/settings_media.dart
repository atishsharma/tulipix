// Settings › Playback, Services & Keys and AI Features, as tiles
...
/// A small label on a quiet ground: a measurement.
class _Tag extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(text,
          style: TextStyle(
              fontSize: 11.5, fontWeight: FontWeight.w500, color: t.textDim)),
    );
  }
}
